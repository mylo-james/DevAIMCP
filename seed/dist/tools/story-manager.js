...
export async function manageStory(args) {
    switch (args.action) {
        case 'create': {
            const s = { id: nextStoryId++, projectId: Number(args.projectId), title: args.title, description: args.description, acceptance_criteria: args.acceptance_criteria, story_points: args.story_points, priority: args.priority };
            stories.push(s);
