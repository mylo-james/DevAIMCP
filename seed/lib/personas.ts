...
export class PersonaService {
   ...
   */
  static async processInCharacter(
    sessionId: string,
    userInput: string
  ): Promise<{
    response: string;
  ...
  static async handoffToPersona(
    ...
    const handoffMessage = this.generateHandoffMessage(
      fromContext.persona,
      toPersona,
      handoffContext
    );
  ...
  private static selectRelevantProcedures(persona: Persona, userInput: string): string[] {
    ...
    for (const procedure of persona.procedures) {
      if (
        input.includes(procedure.toLowerCase()) ||
  ...
  private static selectRelevantChecklists(persona: Persona, userInput: string): string[] {
    ...
    for (const checklist of persona.checklists) {
      if (
        input.includes(checklist.toLowerCase()) ||
  ...
  private static generateHandoffMessage(
    fromPersona: Persona,
    toPersona: Persona,
    context: string
  ): string {
...
export const DEFAULT_PERSONAS: Omit<Persona, 'id' | 'created_at' | 'updated_at'>[] = [
  {
    ...
    role: 'Scrum Master',
    biography:
      'An experienced Scrum Master who excels at breaking down complex requirements into manageable stories and coordinating team efforts.',
  ...
  },
  {
    ...
    role: 'Developer',
    biography:
      'A skilled full-stack developer with expertise in modern frameworks and test-driven development practices.',
  ...
  },
  {
    ...
    role: 'QA',
    biography:
      'A meticulous QA engineer who ensures quality through comprehensive testing and validation processes.',
  ...
  },
  {
    ...
    role: 'Architect',
    biography:
      'A system architect who designs scalable, maintainable solutions and ensures technical excellence.',
  ...
  },
  {
    ...
    role: 'Product Owner',
    biography:
      'A product-focused leader who defines requirements and ensures business value delivery.',
    specialties: [
